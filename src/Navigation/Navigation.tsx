    ...
    return (
        <div className='navigation'>
            <div className={width < 1023 ? 'navigation__links' : 'navigation__links navigation__links_desktop'}>
                ...
                {width < 1023 ? <Link className={!menu ? 'navigation__link' : 'navigation__link navigation__link_hidden' }  to='/practice'>Practice</Link> : <Link className='navigation__link' to='/practice'>Practice</Link>}
