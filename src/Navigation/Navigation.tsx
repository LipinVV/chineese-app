        ...
        <div className='navigation'>
            <div  className={menuIsOpen ? 'navigation__wrapper__hidden' : 'navigation__wrapper'}>
                <div className={width < 1023 ? 'navigation__links' : 'navigation__links navigation__links_desktop'}>
                    ...
                    {width < 1023 ? <Link className={!menuIsOpen ? 'navigation__link' : 'navigation__link navigation__link_hidden' } to='/dictionary'>Dictionary</Link> : <Link className='navigation__link' to='/dictionary'>Dictionary</Link>}
